...
abstract class SingleSkystone_Foundation_NoRotation(alliance: Alliance) : LeagueBotAutoBase(alliance, Pose(72.0 - 9.0, -24.0 - 9.0, (-90.0).toRadians)) {
...
@Autonomous
class Red_SingleSkystone_Foundation_NoRotation : SingleSkystone_Foundation_NoRotation(Alliance.RED)

@Autonomous
class Blue_SingleSkystone_Foundation_NoRotation : SingleSkystone_Foundation_NoRotation(Alliance.BLUE)