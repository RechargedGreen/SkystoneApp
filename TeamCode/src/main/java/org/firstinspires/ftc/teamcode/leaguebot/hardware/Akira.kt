...
class Akira {
    ...
    val leftFront = RevHubMotor("leftFront", Go_19_2::class).brake
    val leftBack = RevHubMotor("leftBack", Go_19_2::class).brake
    val rightFront = RevHubMotor("rightFront", Go_19_2::class).reverse.brake
    val rightBack = RevHubMotor("rightBack", Go_19_2::class).reverse.brake
    ...
    fun update() {
        val mode = if(veloControl) DcMotor.RunMode.RUN_USING_ENCODER else DcMotor.RunMode.RUN_WITHOUT_ENCODER
        leftFront.mode = mode
        leftBack.mode = mode
